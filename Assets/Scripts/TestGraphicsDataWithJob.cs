...
/// </summary>
public class TestGraphicsDataWithJob : MonoBehaviour
{
    public Font font;
        ...
        public void Execute()
        {
            ...
            for (int i = 0; i < totalPosCount; i++)
            {
                foreach (var item in arr)
                {
                    ...
                    {
                        result_pos[index] = item.vertList[j] + pos[i];
                        result_colors[index] = white;
                        result_uv[index] = item.uvs[j];
                        index++;
                    }

                    int indicsCount = item.IndicsCount;
                    ...
                    totalIndics += indicsCount;
                }
            }
            result_count[0] = totalVertex;
            result_count[1] = totalIndics;
        }
    }
